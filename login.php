            ...
            <fieldset>
                ...
                <table>
                    <tr>
                        ...
                        <td><input type="text" id="userid" name="userid" placeholder="ユーザーIDを入力" autocapitalize="off" value="<?php if (!empty($_POST["userid"])) {echo htmlspecialchars($_POST["userid"], ENT_QUOTES);} ?>"></td>
                    </tr>
                    <tr>
